...
class CDCL(var cfg: Configuration) {
     ...
     */
    val dratBuilder get() = cfg.dratBuilder
    ...
    constructor(cfg: Configuration, cnf: CNF) : this(
        cfg,
        cnf.clauses.map { Clause.fromDimacs(it) },
        cnf.numVars,
    )
